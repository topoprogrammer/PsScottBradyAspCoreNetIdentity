...
{
    public class CustomIdentityStore : UserStoreBase<IdentityUser, string, IdentityUserClaim<string>,
        IdentityUserLogin<string>, IdentityUserToken<string>>

    {
        public CustomIdentityStore(IdentityErrorDescriber describer) : base(describer)
        {
        }
